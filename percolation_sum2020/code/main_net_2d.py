...
from space_2d.generation_net.calculation import split_on_clusters, get_grid, NOT_CHECKED, drop_cluster_lower_than, \
    calculate_clusters_diameters, drop_not_conductive_clusters_dict
from space_2d.generation_net.visualize import draw_array_as_grid, map_dict_on_grid, EMPTY
...
plt.imshow(init_grid, cmap='binary', label="Without splitting")
...
print(big_clusters_dict)

for i in big_clusters_dict.keys():
    print(i)
